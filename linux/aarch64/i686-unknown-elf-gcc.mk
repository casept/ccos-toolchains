...
TC_PATH = $(CCOS_PROJECT_ROOT)/toolchains/linux/aarch64/i686-unknown-elf/bin
...
CFLAGS = -nostdlib -ffreestanding -static-libgcc -lgcc -Wall -Wextra -Wpedantic -Werror -Wcast-align -Wcast-qual -Wdisabled-optimization -Wformat=2 -Winit-self -Wlogical-op -Wredundant-decls -Wshadow -Wsign-conversion -Wstrict-overflow=5 -Wswitch-default -Wundef -Wunreachable-code -Wwrite-strings -fdiagnostics-color=always
